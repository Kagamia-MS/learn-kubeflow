...
def train_opts():
    ...
    parser.add_argument("--train_data_path",
                        ...
                        type=str,
                        required=True,
                        help="The train data path. Should be the .tsv files (or other data files) for the task.")
...
def eval_opts():
    ...
    parser.add_argument("--test_data_path",
                        ...
                        type=str,
                        required=True,
                        help="The test data path. Should be the .tsv files (or other data files) for the task.")
    parser.add_argument("--bert_model",
                        default="bert-base-cased",
                        type=str,
                        required=True,
